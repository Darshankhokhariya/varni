    ...
    <div className="bg-white border-b-2">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
        <div className="flex items-center text-center lg:text-left">
          <div className="space-y-10 sm:m-auto">
            {/* Heading */}
            <div className=''> 
              ...
              <h3 className="text-lg md:text-xl md:leading-relaxed capitalize font-medium text-gray-600">
                we build innovative web-application
              </h3>
            </div>
            {/* END Heading */}
            ...
            {/* Action */}
            <div>
              <a href="#" className="inline-flex justify-center no-underline items-center space-x-2 border font-semibold focus:outline-none px-6 py-3 leading-6 rounded-full border-blue-700 bg-blue-700 text-white hover:text-white hover:bg-blue-800 hover:border-blue-800 focus:ring focus:ring-blue-500 focus:ring-opacity-50 active:bg-blue-700 active:border-blue-700">
...
{/* <div>
  ...
  //         <h1 className='uppercase font-semibold px-5 py-16'>Software devlopment <br />  company</h1>
  //         <span className='px-5 text-2xl'>We
  //           <span className='text-blue-500  capitalize text-lg'> bring reality in to your ideas </span>
  //         </span>
  //         <button className="bg-blue-500  px-3 py-2   text-white rounded-full">
  //           Let's Get Connect
  //         </button>
  //         <div className='absolute top-0 bottom-0 right-10 left-0 flex justify-end object-cover'>
  //           <img className='h-96' src={require('../images/1.webp')} alt="" />
  //         </div>
  //       </div>
  //     </div>
  // </div> */}